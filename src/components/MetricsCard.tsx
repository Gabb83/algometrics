...
export default function MetricsCards({
  ...
  return (
    <div className="w-full max-w-7xl mx-auto">
      {/* GRID UNIFICADO: 7 Colunas com visual premium integrado */}
      <div className="grid grid-cols-1 sm:grid-cols-7 gap-4 w-full">
        ...
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-4 flex flex-col justify-between relative overflow-hidden shadow-xs">
          ...
          <div className="absolute bottom-0 left-0 right-0 h-[2px] bg-indigo-500/40 dark:bg-indigo-500/30" />
        </div>
        ...
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-4 flex flex-col justify-between relative overflow-hidden shadow-xs">
          ...
          <p className="text-xl font-mono font-bold text-rose-500 mt-2">{complexidade.piorCaso}</p>
          <div className="absolute bottom-0 left-0 right-0 h-[2px] bg-rose-500/40 dark:bg-rose-500/30" />
        </div>
        ...
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-4 flex flex-col justify-between relative overflow-hidden shadow-xs">
          ...
          <p className="text-xl font-mono font-bold text-emerald-500 mt-2">{complexidade.melhorCaso}</p>
          <div className="absolute bottom-0 left-0 right-0 h-[2px] bg-emerald-500/40 dark:bg-emerald-500/30" />
        </div>

        {/* 4. Card de Espaço Auxiliar */}
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-4 flex flex-col justify-between relative overflow-hidden shadow-xs">
          <div className="flex justify-between items-center w-full">
            <p className="text-[10px] font-bold text-zinc-400 dark:text-zinc-500 uppercase tracking-wider">Espaço</p>
            <div className="w-1.5 h-1.5 rounded-full bg-blue-500 shadow-[0_0_8px_rgba(59,130,246,0.5)]" />
          </div>
          <p className="text-xl font-mono font-bold text-blue-500 mt-2">{complexidade.espaco}</p>
          <div className="absolute bottom-0 left-0 right-0 h-[2px] bg-blue-500/40 dark:bg-blue-500/30" />
        </div>

        {/* 5. Card de Comparações */}
        <div className="bg-zinc-100/40 dark:bg-zinc-900/40 border border-zinc-200 dark:border-zinc-800 rounded-xl p-4 flex flex-col justify-between relative overflow-hidden shadow-xs">
          ...
          <p className="text-xl font-bold font-mono text-zinc-800 dark:text-zinc-100 mt-2">{comparacoes}</p>
          <div className="absolute bottom-0 left-0 right-0 h-[2px] bg-amber-500/30 dark:bg-amber-500/20" />
        </div>
        ...
        <div className="bg-zinc-100/40 dark:bg-zinc-900/40 border border-zinc-200 dark:border-zinc-800 rounded-xl p-4 flex flex-col justify-between relative overflow-hidden shadow-xs">
          ...
          <p className="text-xl font-bold font-mono text-zinc-800 dark:text-zinc-100 mt-2">{trocas}</p>
          <div className="absolute bottom-0 left-0 right-0 h-[2px] bg-indigo-500/30 dark:bg-indigo-500/20" />
        </div>
